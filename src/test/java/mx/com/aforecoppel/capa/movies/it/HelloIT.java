package mx.com.aforecoppel.capa.movies.it;
...
public class HelloIT{
	...
	public void hello() throws IOException {
		...
		HttpURLConnection connection = (HttpURLConnection)new URL("http://localhost:" + port +"/tallerSpring/getUsuariosRest").openConnection();
		{
			connection.connect();
